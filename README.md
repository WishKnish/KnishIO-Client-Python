...
- 🐛 Issues: [GitHub Issues](https://github.com/WishKnish/KnishIO-Client-Python/issues)
...
The Python SDK maintains 100% cryptographic compatibility with all other SDKs through the Node.js bridge architecture. This ensures identical ML-KEM768 encryption/decryption across platforms.

### Prerequisites

- Python 3.11 or higher
- Node.js 16 or higher (required for ML-KEM768 cryptography)
- Virtual environment (recommended)
...
git clone https://github.com/WishKnish/KnishIO-Client-Python.git
cd KnishIO-Client-Python
...
python -m pytest --cov=knishioclient --cov-report=html
```
...
See also the list of [contributors](https://github.com/WishKnish/KnishIO-Client-Python/contributors) who participated in this project.
